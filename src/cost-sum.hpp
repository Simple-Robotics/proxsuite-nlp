...
namespace lienlp
{
  ...
  CostSum<Scalar> operator+(const CostFunctionBase<Scalar>& left, const CostFunctionBase<Scalar>& right)
  {
  ...
  template<typename Scalar>
  CostSum<Scalar>&& operator+(CostSum<Scalar>&& left, const CostFunctionBase<Scalar>& right)
  {
    left += right;
  ...
  template<typename Scalar>
  CostSum<Scalar> operator*(const Scalar& left, const CostFunctionBase<Scalar>& right)
  {
