...
void exposeWorkspace() {
  ...
  bp::class_<context::Workspace>("Workspace", "SolverTpl workspace.",
      ...
      .def_readonly("kkt_matrix", &context::Workspace::kktMatrix,
                    "KKT matrix buffer.")
      .def_readonly("kkt_rhs", &context::Workspace::kktRhs,
                    "KKT system right-hand side buffer.")
      .def_readonly("cstr_values", &context::Workspace::cstrValues,
                    "Vector constraint residuals.")
      .def_readonly("dual_residuals", &context::Workspace::dualResidual,
      ...
      .def_readonly("cstr_jacobians", &context::Workspace::cstrJacobians,
                    "Block jacobians.")
      .def_readonly("lams_plus", &context::Workspace::lamsPlus,
                    "First-order multiplier estimates.")
      .def_readonly("lams_pdal", &context::Workspace::lamsPDAL,
