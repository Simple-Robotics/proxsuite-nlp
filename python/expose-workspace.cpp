  ...
  namespace python
  {
    void exposeWorkspace()
    {
      ...
      bp::class_<context::Workspace>(
        ...
        .def_readonly("cstr_values", &context::Workspace::cstrValues, "Vector constraint residuals.")
        ...
        .def_readonly("cstr_jacobians", &context::Workspace::cstrJacobians, "Block jacobians.")
