...
void exposeFunctionTypes() {
  ...
  bp::class_<internal::FunctionWrap, boost::noncopyable>(
  ...
  bp::class_<internal::C1FunctionWrap, bp::bases<Function>, boost::noncopyable>(
