...
void exposeProblem() {
  ...
  bp::class_<Problem, shared_ptr<Problem>>(
      ...
      bp::init<const context::Cost &, const std::vector<ConstraintPtr> &>(
      ...
      .add_property("constraint_dims", &Problem::getConstraintDims,
                    "Get the dimensions of the constraint blocks.")
